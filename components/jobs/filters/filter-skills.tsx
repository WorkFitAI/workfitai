...
const FilterSkills = () => {
  ...
  useEffect(() => {
    // The mount-only effect above already fetches page 0 with no keyword —
    // skip this effect's first run so it doesn't fire a redundant duplicate
    // fetch (and race with actions like pagination) shortly after mount.
